...
public class DisableKeyRotationRequest {
    ...
    public DisableKeyRotationRequest withBody(OperateKeyRequestBody body) {
        this.body = body;
        return this;
    }

    public DisableKeyRotationRequest withBody(Consumer<OperateKeyRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DisableKeyRotationRequest that = (DisableKeyRotationRequest) obj;
