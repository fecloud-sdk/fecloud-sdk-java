...
public class ShowPublicKeyRequest {
    ...
    public ShowPublicKeyRequest withBody(OperateKeyRequestBody body) {
        this.body = body;
        return this;
    }

    public ShowPublicKeyRequest withBody(Consumer<OperateKeyRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPublicKeyRequest that = (ShowPublicKeyRequest) obj;
