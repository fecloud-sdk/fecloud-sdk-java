...
public final class Constants {
    ...
    public static final String DEFAULT_IAM_ENDPOINT = "https://iam.eu-west-0.prod-cloud-ocb.orange-business.com";

    public static final String IAM_ENDPOINT_ENV_NAME = "FECLOUD_SDK_IAM_ENDPOINT";
    ...
    public static final String DEFAULT_PROFILE_DIR_NAME = ".fecloud";
