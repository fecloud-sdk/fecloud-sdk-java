...
import com.fecloud.sdk.core.auth.ICredential;
import com.fecloud.sdk.core.exception.DefaultExceptionHandler;
import com.fecloud.sdk.core.exception.ExceptionHandler;
import com.fecloud.sdk.core.exception.HostUnreachableException;
import com.fecloud.sdk.core.exception.SdkException;
import com.fecloud.sdk.core.exception.ServerResponseException;
import com.fecloud.sdk.core.exception.ServiceResponseException;
import com.fecloud.sdk.core.exchange.ApiReference;
import com.fecloud.sdk.core.exchange.SdkExchange;
import com.fecloud.sdk.core.exchange.SdkExchangeCache;
import com.fecloud.sdk.core.http.Field;
import com.fecloud.sdk.core.http.HttpClient;
...
import com.fecloud.sdk.core.http.SdkFormDataBody;
import com.fecloud.sdk.core.impl.DefaultHttpClient;
import com.fecloud.sdk.core.progress.ProgressInputStream;
import com.fecloud.sdk.core.progress.ProgressRequest;
import com.fecloud.sdk.core.progress.SimpleProgressManager;
import com.fecloud.sdk.core.utils.CastUtils;
import com.fecloud.sdk.core.utils.ExceptionUtils;
import com.fecloud.sdk.core.utils.HttpUtils;
import com.fecloud.sdk.core.utils.JsonUtils;
...
import static com.fecloud.sdk.core.Constants.SDK_EXCHANGE;
...
public class HcClient implements CustomizationConfigure {
    ...
    public static class AccessLog {
        private static final Logger logger = LoggerFactory.getLogger("FECloud-SDK-Access");
    ...
    protected <R, S> HttpRequest buildRequest(R request, HttpRequestDef<R, S> reqDef) {
        ...
        httpRequestBuilder.addHeader(Constants.USER_AGENT, "fecloud-usdk-java/3.0");
